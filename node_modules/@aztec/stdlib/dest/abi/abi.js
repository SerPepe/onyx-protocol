...
export const FunctionAbiSchema = z.object({
    name: z.string(),
    functionType: z.nativeEnum(FunctionType).optional(),
    isInternal: z.boolean().optional().default(false),
    isStatic: z.boolean().optional().default(false),
    isInitializer: z.boolean().optional().default(false),
    parameters: z.array(z.object({
        name: z.string(),
        type: AbiTypeSchema,
        visibility: z.enum(ABIParameterVisibility)
    })).optional().default([]),
    returnTypes: z.array(AbiTypeSchema).optional().default([]),
    errorTypes: z.record(AbiErrorTypeSchema).optional().default({})
});
...
export const FunctionArtifactSchema = FunctionAbiSchema.and(z.object({
    ...
    debugSymbols: z.string().optional().default(""),
...
export const ContractArtifactSchema = z.object({
    ...
    nonDispatchPublicFunctions: z.array(FunctionAbiSchema).optional().default([]),
    outputs: z.object({
